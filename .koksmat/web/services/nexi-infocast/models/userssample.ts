...
//
//   const userssample = Convert.toUserssample(json);
//
...
export class Convert {
    public static toUserssample(json: string): Userssample[] {
        return cast(JSON.parse(json), a(r("Userssample")));
    }

    public static userssampleToJson(value: Userssample[]): string {
        return JSON.stringify(uncast(value, a(r("Userssample"))), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Fields": o([
        ...
        { json: "AppAuthorLookupId", js: "AppAuthorLookupId", typ: "" },
        { json: "AppEditorLookupId", js: "AppEditorLookupId", typ: "" },
        ...
        { json: "LinkTitle", js: "LinkTitle", typ: "" },
        { json: "LinkTitleNoMenu", js: "LinkTitleNoMenu", typ: "" },
