...
//
//   const infocastGroupSegments = Convert.toInfocastGroupSegments(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface InfocastGroupSegments {
...
export interface FieldValues {
    ...
    Hidden:                    boolean;
    ID:                        number;
    InfoCast_x0020_Groups:     AppAuthor[];
    InstanceID:                null;
...
export enum FileDirRef {
    SitesInfoCastListsInfoCastGroupSegments = "/sites/InfoCast/Lists/InfoCast Group Segments",
}

export enum ParentUniqueID {
    The9B7Ac2153E494C088256Fa5Fb7760B86 = "{9B7AC215-3E49-4C08-8256-FA5FB7760B86}",
}

export enum ScopeID {
    The559A137300E749A3B007E10Be8915658 = "{559A1373-00E7-49A3-B007-E10BE8915658}",
}

// Converts JSON strings to/from your types
// and asserts the results of JSON.parse at runtime
export class Convert {
    public static toInfocastGroupSegments(json: string): InfocastGroupSegments[] {
        return cast(JSON.parse(json), a(r("InfocastGroupSegments")));
    }

    public static infocastGroupSegmentsToJson(value: InfocastGroupSegments[]): string {
        return JSON.stringify(uncast(value, a(r("InfocastGroupSegments"))), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "FieldValues": o([
        ...
        { json: "AppEditor", js: "AppEditor", typ: r("AppAuthor") },
        { json: "Attachments", js: "Attachments", typ: true },
        { json: "Author", js: "Author", typ: r("AppAuthor") },
        { json: "CenturionID", js: "CenturionID", typ: null },
        ...
        { json: "ID", js: "ID", typ: 0 },
        { json: "InfoCast_x0020_Groups", js: "InfoCast_x0020_Groups", typ: a(r("AppAuthor")) },
    ...
    "FileDirRef": [
        "/sites/InfoCast/Lists/InfoCast Group Segments",
    ],
    "ParentUniqueID": [
        "{9B7AC215-3E49-4C08-8256-FA5FB7760B86}",
    ],
    "ScopeID": [
        "{559A1373-00E7-49A3-B007-E10BE8915658}",
    ],
};
